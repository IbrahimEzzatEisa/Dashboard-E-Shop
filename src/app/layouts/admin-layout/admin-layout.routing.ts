...
const AdminLayoutRoutes: Routes = [{
    ...
    children: [
      ...
      {
        path: 'problem',
        loadChildren: () => import('../admin-layout/problem/problem.module').then(m => m.ProblemModule),
      },
  
      
      {
        path: 'pharma',
        loadChildren: () => import('../admin-layout/pharma/pharma.module').then(m => m.PharmaModule),
      },

      {
        path: 'image',
        loadChildren: () => import('../admin-layout/homeimage/homeimage.module').then(m => m.HomeimageModule),
      },
    ]
